...
; CHECK-NEXT:   %0 = load <4 x i64>, ptr %a, align 32
; CHECK-NEXT:   %1 = load <4 x i64>, ptr %b, align 32
; CHECK-NEXT:   %2 = add <4 x i64> %0, %1
; CHECK-NEXT:   store <4 x i64> %2, ptr %c, align 32
...
entry:
  ...
  %arrayidx4 = getelementptr inbounds [4 x i64], ptr %a, i64 0, i64 1
  %2 = load i64, ptr %arrayidx4, align 8
  %arrayidx5 = getelementptr inbounds [4 x i64], ptr %b, i64 0, i64 1
  %3 = load i64, ptr %arrayidx5, align 8
  %add6 = add i64 %2, %3
  %arrayidx7 = getelementptr inbounds [4 x i64], ptr %c, i64 0, i64 1
  store i64 %add6, ptr %arrayidx7, align 8
  %arrayidx8 = getelementptr inbounds [4 x i64], ptr %a, i64 0, i64 2
  %4 = load i64, ptr %arrayidx8, align 16
  %arrayidx9 = getelementptr inbounds [4 x i64], ptr %b, i64 0, i64 2
  %5 = load i64, ptr %arrayidx9, align 16
  %add10 = add i64 %4, %5
  %arrayidx11 = getelementptr inbounds [4 x i64], ptr %c, i64 0, i64 2
  store i64 %add10, ptr %arrayidx11, align 16
  %arrayidx12 = getelementptr inbounds [4 x i64], ptr %a, i64 0, i64 3
  %6 = load i64, ptr %arrayidx12, align 8
  %arrayidx13 = getelementptr inbounds [4 x i64], ptr %b, i64 0, i64 3
  %7 = load i64, ptr %arrayidx13, align 8
  %add14 = add i64 %6, %7
  %arrayidx15 = getelementptr inbounds [4 x i64], ptr %c, i64 0, i64 3
  store i64 %add14, ptr %arrayidx15, align 8
